...
(async () => {
    try {
        ...
        if (a.listingTokens._erc20Token != "0x0000000000000000000000000000000000000000") {
            ...
            erc20.approve(a.listingTokens._erc20Token, args[0], a.listingTokens._price, 0);
        }

        // purchase token
        const tx = await marketplaceService.purchaseToken(args[0], args[1], a.listingTokens._price, 0);
