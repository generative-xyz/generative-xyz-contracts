...
class GENTokenTestnet {
    ...
    async deployUpgradeable(name: string,
        ...
        const contract = await ethers.getContractFactory("GENTokenTestnet");
        console.log("GENTokenTestnet.deploying ...")
    ...
    getContract(contractAddress: any, contractName: any = "./artifacts/contracts/erc20/GENTokenTestnet.sol/GENTokenTestnet.json") {
    ...
    async upgradeContract(proxyAddress: any) {
        const contractUpdated = await ethers.getContractFactory("GENTokenTestnet");
        console.log('Upgrading GENTokenTestnet... by proxy ' + proxyAddress);
