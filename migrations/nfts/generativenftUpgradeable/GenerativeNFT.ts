...
class GenerativeNFTUpgradeable {
    network: string;
    ...
    getContract(contractAddress: any) {
        ...
        // load contract
        let contract = require(path.resolve("./artifacts/contracts/nfts/GenerativeNFTUpgradeable.sol/GenerativeNFTUpgradeable.json"));
...
export {GenerativeNFTUpgradeable};