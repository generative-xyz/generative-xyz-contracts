...
class CryptoAI {
  ...
  async deployUpgradeable(name: string, symbol: string, deployerAddr: any) {
  ...
  getContract(
    contractAddress: any,
    contractName: any = "./artifacts/contracts/nfts/CryptoAI.sol/CryptoAI.json"
  ) {
    console.log(
      "Network run",
      this.network,
  ...
  async changeCryptoAiDataAddress(
    contractAddress: any,
    gas: any,
    newAddr: any
  ) {
