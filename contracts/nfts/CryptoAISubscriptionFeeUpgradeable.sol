 ...
 */
abstract contract CryptoAISubscriptionFeeUpgradeable is Initializable, CryptoAIUpgradeable {
     ...
     */
    function getSubscriptionFee(uint256 agentId) public view virtual returns (uint256) {
