...
contract RoyaltyFinanceSecondSale is OwnableUpgradeable, ReentrancyGuardUpgradeable, IRoyaltyFinanceSecondSale {
    ...
    function withdraw(uint256 projectId, address erc20Addr, uint256 amount) external {
        require(_royaltySecondSale[projectId][msg.sender][erc20Addr] > amount);
        bool success;
    ...
    function setRoyaltySecondSale(uint256 tokenId, address receiver, address erc20Addr, uint256 amount) external payable nonReentrant {
